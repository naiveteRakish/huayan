...
public class MyBatisDaoTest {
	...
	public void testGetDao() {
		...
		factory = (IDbSessionFactory)context.getBean("myBatisSessionFactory");
		...
		IDbSystemInfoDAO dao = beanService.getBean(DbSystemInfoDaoMyBatisImpl.class);
		...
		try {
			...
			dao = (IDbSystemInfoDAO)context.getBean("MyBatisDbSystemInfoDAO");
			System.out.println("创建Dao成功！");
